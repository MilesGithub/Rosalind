...
'''
def expected_offspring(genotype_counts):

    probabilities = [1.0, 1.0, 1.0, 0.75, 0.5, 0.0]
    # Expected number of offspring for each genotype pairing
    expected_offspring = sum(genotype_counts[i] * probabilities[i] * 2 for i in range(6))

    return expected_offspring

genotype_counts = [18828, 16426, 19680, 17396, 19089, 16886]
result = expected_offspring(genotype_counts)
print(result)
